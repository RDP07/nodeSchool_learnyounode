/*# LEARN YOU THE NODE.JS FOR MUCH WIN!  
 ...
 ## HINTS  
  ...
  from the Node core library. To load this kind of module, or any other  
  ...
  fs.readFileSync('/path/to/file'). This method will return a Buffer  
  ...
  string, recall that a JavaScript String can be .split() into an array  
  of substrings and that '\n' can be used as a delimiter. Note that the  
  test file does not have a newline character ('\n') at the end of the  
  last line, so using this method you'll end up with an array that has  
...
var newLines = strSplit.length - 1;
